...
export default class EdicaoPets extends Component<props> {

    render() {
        let tema = this.props.tema
        return (
            <div>
                <h2 className="text-center">Edição de Pets</h2>
                    ...
                    <form>
                        ...
                        <div className="input-group mb-3 d-flex justify-content-center">
                            <button className="btn btn-outline-danger" type="button"
                                onClick={(x) => this.props.seletorView('Pets', x)}>Deletar</button>
                            <button className="btn btn-outline-dark" type="button"
                                onClick={(x) => this.props.seletorView('Pets', x)}>Alterar</button>
                        </div>
                    </form>
                </div>
            </div>
